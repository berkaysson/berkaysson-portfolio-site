  ...
  return (
    <div>
      ...
      <div>
        ...
        <p>
          Lifemap empowers users to take control of their time and achieve their
          goals. For instance, if you're learning a new instrument and want to
          establish a regular practice routine, Lifemap allows you to create a
          habit with a defined frequency (daily, weekly, or monthly). You can
          then track your progress by adding activities whenever you practice
          the instrument.
        </p>
        <p>
          ...
          improvement, I am actively working on enhancing Lifemap by adding more
          visual interactions, such as charts and other interactive elements.
        </p>
      ...
      <div>
        ...
        <p>
          ...
          command of create-react-app, component-based nature, useful hooks and
          efficient rendering. To ensure a visually appealing and responsive
          design; CSS, Material UI, and styled-components were employed for
          styling and theming.
        </p>
        <p>
          Given the extensive range of features, I opted to create Lifemap as a
          single-page web application using React Router, enabling seamless
          navigation and a smooth user experience. As for data management, I
          initially implemented IndexedDB with Dexie.js, which provided offline
          storage and guest mode capabilities. Additionally, to enable
          multi-device usage and user authentication, I integrated Firebase Auth
          and Firebase Realtime Database, allowing users to access their data
          securely across multiple devices while also offering a guest mode
          option. And finally i deploy the app with Github-Pages. This
      ...
      <div>
        ...
        <p>
          ...
          nature of the databases' APIs (IndexedDB and Realtime DB) and managing
          the state within the React hook of useState, which also operates
          asynchronously. It required careful coordination to ensure that the
          databases and app states interacted smoothly. To tackle this, I
          employed Promises and leveraged the useEffect hook to efficiently
          fetch and synchronize data.
        </p>
        <p>
          The development of Lifemap also presented other challenges. Designing
          the logic for tracking tasks and habits proved to be a complex task.
          Furthermore managing numerous functions, components, and files
          demanded a high level of organization and attention to detail. As my
          largest project to date, I dedicated myself to ensuring that the
          codebase was reuseable, well-structured and organized.
        </p>
